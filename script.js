...
const PRODUCTS_PROMO = [
  {
    ...
    variants: [
      { label: "1P1U — 1 Bulan", price: 36000 },
...

  {
    ...
    variants: [
      { label: "IMESS — 1 Bulan", price: 6000 },
      { label: "IMESS — 3 Bulan", price: 10000 },
    ]
  },

  {
    ...
    img: "Gambar/viu.jpeg",
    variants: [
      { label: "PRIVATE — 1 Bulan", price: 5000 },
      { label: "PRIVATE — 1 Tahun", price: 20000 },
    ]
  },

  {
    ...
    variants: [
      { label: "FAMPLAN — 1 Bulan", price: 18000 },
      { label: "INDPLAN — 1 Bulan", price: 24000 },
    ]
  },

  {
    ...
    variants: [
      ...
      { label: "PRIVATE — 1 Bulan", price: 13000 },
    ]
  },

  {
    ...
    variants: [
      { label: "PRIVATE — 1 Bulan", price: 6000 },
      { label: "PRIVATE — 1 Tahun", price: 20000 },
    ]
  },

  {
    ...
    variants: [
      { label: "SHARING — 1 Bulan", price: 25000 },
...

  {
    ...
    variants: [
      { label: "MEMBER — 1 Bulan", price: 6000 },
      { label: "MAMBER — 1 Tahun", price: 19000 },
    ]
  },

  {
    ...
    variants: [
      { label: "SHARING — 1 Bulan", price: 8000 },
      { label: "PRIVATE — 1 Bulan", price: 28000 },
    ]
  },

  {
    ...
    variants: [
      ...
      { label: "SHARING — 3 Bulan", price: 40000 },
    ]
  },

  {
    ...
    variants: [
      { label: "SHARING — 1 Bulan", price: 8000 },
      { label: "SHARING — 1 Tahun", price: 29000 },
    ]
  },

  {
    id: "promo-alight motion",
    name: "Alight Motion",
    img: "Gambar/alight motion.jpeg",
    variants: [
      { label: "SHARING — 1 Tahun", price: 10000 },
      { label: "PRIVATE — 1 Tahun", price: 18000 },
    ]
  },

   {
    ...
    variants: [
      { label: "SHARING — 1 bulan", price: 8000 },
      { label: "SHARING — 1 Tahun", price: 15000 },
    ]
  },

   {
    ...
    variants: [
      { label: "SHARING — 1 Bulan", price: 6000 },
      { label: "SHARING — 1 Tahun", price: 12000 },
    ]
  },

   {
    ...
    variants: [
      { label: "FAMPLAN — 1 Bulan", price: 6000 },
      { label: "INDPLAN — 1 Bahun", price: 12000 },
    ]
  },

   {
    ...
    variants: [
      ...
      { label: "PRIVATE — 1 Bulan", price: 9000 },
    ]
  },

   {
    ...
    variants: [
      { label: "SHARING — 7 Hari", price: 10000 },
      { label: "SHARING — 1 Bulan", price: 19000 },
    ]
  },

   {
    ...
    variants: [
      { label: "PRIVATE — 7 Hari", price: 10000 },
    ]
  },
...

{
    ...
    variants: [
      { label: "GEMINI 2TB — 1 Bulan", price: 10000 },
      { label: "GEMINI 2TB — 2 Bulan", price: 15000 },
    ]
  },
...
renderProducts(PRODUCTS_PROMO, 'products-promo');
...
document.getElementById("checkoutForm").addEventListener("submit", function(e){
  ...
  msg += "🔥 *" + CONFIG.SITE_NAME + " — Order Baru*" + "%0A%0A";

  msg += "📦 Produk: *" + selectedProduct.name + "*" + "%0A";
  msg += "🔖 Varian: *" + selectedVariant.label + "*" + "%0A";
  msg += "💵 Harga: *" + money(selectedVariant.price) + "*" + "%0A%0A";

  msg += "👤 *Data Pembeli*" + "%0A";
  msg += "Nama: " + buyerName + "%0A";
  msg += "WhatsApp: " + buyerWA + "%0A";
  msg += "Email: " + buyerEmail + "%0A";
  msg += "Catatan: " + note + "%0A%0A";

  msg += "💳 Pembayaran: " + pay + "%0A%0A";

  msg += "Terima kasih, admin!";

  // ============================
  //   SEND TO WHATSAPP
  // ============================
  const url = `https://wa.me/${CONFIG.OWNER_WA_NUMBER}?text=${msg}`;
